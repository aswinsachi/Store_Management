...
public class MailUtil {  
    ...
    private String FROM_ADDRESS = "amrithastoresteam@gmail.com";  
    private String PASSWORD = "amritha@123";  
    private String FROM_NAME = "Order Mail";  
  
    public boolean sendMail(String[] recipients, String[] bccRecipients, String subject, String message) {  
        System.out.println(" here inside mail");
        try {  
            System.out.println(" here enting mail");
    ...
    public static void main(String[] args) {
       ...
       rec[0] = "project8asas@gmail.com";     
        obj.sendMail(rec, rec, "Test", "Hi");
    }
}  
