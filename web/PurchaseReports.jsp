...
<div class="container">
     ...
     <h1 style="margin-left: 400px">  Purchase Reports </h1>
   <div style="height: 40px"></div>
   <%
   
                                          String sql="select * from orders  as o join item as i where i.itemid=o.itemid  and o.status=1";
...
if(!rs.isBeforeFirst()){
 ...
 <table border="1" class="table table-condensed"  style="border-collapse: separate;margin-left: 20px;column-width:100px">
	...
	{
	%>
        <td>  <a href="DeliverOrder.jsp?orderid=<%=orderid%>" class="btn btn-primary">purchased</a></td>
    <%
	}
	else
	{%>
        <td><p class='label label-success'>Purchased</p></td>   
	<%}
	%>
