    ...
    <body>
        ...
        <script>
            function getIdfun() {
                ...
                xmlhttp.open("GET", "GenerateOrder.jsp?req=req", true);
                xmlhttp.send();
            }
        </script>
        ...
        <h1 style="margin-left: 400px">  Orders </h1>
        <div style="height: 40px"></div>
        <form class="form-horizontal" action="AddOrderAction.jsp"  method="POST">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Order id</label>  
                    <div class="col-md-4" id="oiddiv">
                        <input id="oid" name="oid"  type="text" placeholder="Click to Autogenerate Order"  class="form-control input-md" onclick="getIdfun()" required>   
                    </div>
                </div>
